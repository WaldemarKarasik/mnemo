<footer x-data = "{showAb: false}" class="fixed bottom-0 h-20 bg-teal-600 w-full flex justify-between">
    ...
    <div class="w-7/12 flex flex-col justify-center bg-red-500">
        <div style="visibility: hidden;"class="flex items-center bg-blue-500 text-white text-sm font-bold px-4" role="alert">
    ...
    <div class="flex items-center text-teal-300">
        <button wire:click="$emit('tallClicked')">Click</button>
